...
*/
/**
 * This is a class to test all the brains created.
 * A setup routine that creates a couple of  beasts and a random
 * walker at random locations all in a same pack.
 * 
 * <p>
 * 
 * @author William
 */
public class MySetup implements IBeastProvider {
	/**
	 * My sweet, beasts.
	 */
	 ...
	 */
	public MySetup(int width, int height) {
		beasties = new Beast[6];
		beasties[0] = new Beast(new SpinnyBrain(), new AllBeastsPack(this));
		grooveBeastRandomly(beasties[0]);

		beasties[1] = new Beast(new FlockBrain(), new AllBeastsPack(this));
		
		beasties[2] = new Beast(new GroupieBrain(), new AllBeastsPack(this));	

		beasties[3] = new Beast(new RandomWalkingBrain(), new AllBeastsPack(this));
		grooveBeastRandomly(beasties[3]);

		beasties[4] = new Beast (new LonelyBrain(), new AllBeastsPack(this));
		
		beasties[5] = new Beast (new FollowerBrain(), new AllBeastsPack(this));
