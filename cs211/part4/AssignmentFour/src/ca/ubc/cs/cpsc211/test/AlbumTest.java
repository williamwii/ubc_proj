...
public class AlbumTest {
	...
	/* removed to make setName package instead of public
	@Test
	...
	*/
	...
	@Test
	public void testAddPhoto() throws PhotoAlreadyInAlbumException {
	...
	public void testAddMoreThanOnePhoto() throws PhotoAlreadyInAlbumException {
		album1.addPhoto(photo1);
	...
	@Test
	public void testMovePhotoBetweenAlbums() throws PhotoAlreadyInAlbumException, PhotoDoesNotExistException {
		album1.addPhoto(photo1);
	...
	@Test
	public void testRemovePhoto() throws PhotoDoesNotExistException, PhotoAlreadyInAlbumException {
		album1.addPhoto(photo1);
		album1.removePhoto(photo1);
	}
