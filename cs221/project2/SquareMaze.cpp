...
int SquareMaze::SquareMazeNode::getX (void) const
{
  return x;
}
int SquareMaze::SquareMazeNode::getY (void) const
{
  return y;
}
...
int SquareMaze::SquareMazeNode::getMazeWidth (void) const
{
  return maze->getWidth();
}
int SquareMaze::SquareMazeNode::getMazeHeight (void) const
{
  return maze->getHeight();
}
int SquareMaze::SquareMazeNode::getExitX (void) const
{
  return maze->exitNode->getX();
}
int SquareMaze::SquareMazeNode::getExitY (void) const
{
  return maze->exitNode->getY();
}
